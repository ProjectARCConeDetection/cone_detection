...
def fully_connected(input_image, eps_regularization, dropout):
    #First fully connected layer.
    fc1 = tf.contrib.layers.fully_connected(input_image, num_outputs=2048, activation_fn = tf.nn.relu, 
...
def conv_net(input_image, eps_regularization, dropout): 
